...
def trackMultipleObjects():
    ...
    carLocation2 = {}
    speed = [None] * 1000
    out = cv2.VideoWriter('outer.avi',cv2.VideoWriter_fourcc('M','J','P','G'),10,(WIDTH,HEIGHT))
    ...
    while True:
        ...
        for carID in carTracker.keys():
            ...
            cv2.imshow("abc.jpg",trackingQuality)
        ...
        for carID in carIDtoDelete:
            ...
            print ('Removing carID' + str(carID) + 'currentnLocation.')
                ...
                if frameCounter % 1 == 0:
                    ...
                    if [x1, y1, w1, h1] != [x2, y2, w2, h2]:
                        if (speed[i] == None or speed[i] == 0) and y1 >= 275 and y1 <= 285:
                            ...
                            info = "{},{},{},{},{},{}\n".format(year,month,day, time1, speed[i],0)
                            logFile.write(info)
